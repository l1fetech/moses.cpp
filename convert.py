...
# TODO: match this with `moses_ftype`
# TODO: rename to MOSESFileType
...
class Params:
    ...
    def loadOriginalParamsJson(model: LazyModel, config_path: Path) -> Params:
        ...
        # hack to determine MOSES v1 vs v2 vs CodeMoses
        if config.get("moe"):
            # Mixtral
            n_ctx = 32768
...
def merge_sharded(models: list[LazyModel]) -> LazyModel:
    # Original MOSES models have each file contain one part of each tensor.
...
def main(args_in: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(description="Convert a MOSES model to a GGML compatible file")
