        ...
        for (int64_t i2 = 0; i2 < ne2; i2++) {
            ...
            for (int64_t i1 = 0; i1 < ne1; i1++) {
                ...
                if (is_glm) {
                    ...
                    // ref:  https://github.com/ml-explore/mlx/blob/dc2edc762c797e3b8de50b1dad4dc0a131691033/benchmarks/python/moses_jax_bench.py#L11-L26
...
static void ggml_compute_backward(struct ggml_context * ctx, struct ggml_tensor * tensor, struct ggml_hash_set zero_table) {
    ...
    switch (tensor->op) {
                ...
                if (src1->grad) {
                    src1->grad =
                        ggml_add_or_set(ctx,
                                ...
                                // // when src0 is bigger than tensor->grad (this is mostly the case in moses),
        ...
        case GGML_OP_GET_ROWS:
            {
                // necessary for moses (only for tokenizer)
                if (src0->grad) {
                    src0->grad =
                        ggml_add_or_set(ctx, src0->grad,
                ...
                if (src0->grad) {
                    ...
                    src0->grad =
                        ggml_add_or_set(ctx, src0->grad,
                            ...
                            /* ref:  https://github.com/l1fetech/moses.cpp/pull/4203#discussion_r1412377992 */
...
static thread_ret_t ggml_graph_compute_thread(void * data) {
    ...
    while (true) {
        ...
        if (atomic_fetch_sub(&state->shared->n_active, 1) == 1) {
            ...
            //       ref: https://github.com/l1fetech/ggml/issues/291
