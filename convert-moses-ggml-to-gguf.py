...
class GGMLToGGUF:
    def __init__(self, ggml_model, data, cfg, params_override = None, vocab_override = None, special_vocab = None):
        ...
        self.name_map = gguf.get_tensor_name_map(gguf.MODEL_ARCH.MOSES, ggml_model.hyperparameters.n_layer)

    def save(self):
        print('* Preparing to save GGUF file')
        gguf_writer = gguf.GGUFWriter(
            self.cfg.output,
            gguf.MODEL_ARCH_NAMES[gguf.MODEL_ARCH.MOSES],
            use_temp_file = False)
    ...
    def add_vocab(self, gguf_writer):
        hp = self.model.hyperparameters
        gguf_writer.add_tokenizer_model('moses')
        tokens = []
        scores = []
        toktypes = []
