...
# Define the path to the moses directory (parent folder of script directory)
moses_path = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir))

# Define the file with the list of hashes and filenames
hash_list_file = os.path.join(moses_path, "SHA256SUMS")
...
for line in hash_list:
    ...
    # Get the full path of the file by joining the moses path and the filename
    file_path = os.path.join(moses_path, filename)
