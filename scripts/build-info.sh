...
echo "int MOSES_BUILD_NUMBER = ${build_number};"
echo "char const *MOSES_COMMIT = \"${build_commit}\";"
echo "char const *MOSES_COMPILER = \"${build_compiler}\";"
echo "char const *MOSES_BUILD_TARGET = \"${build_target}\";"
