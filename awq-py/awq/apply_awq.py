"""
Implements the AWQ for moses.cpp use cases.
...
from transformers.models.moses.modeling_moses import MosesRMSNorm
...
def apply_scale(module, scales_list, input_feat_dict=None):
    ...
    for prev_op_name, layer_names, scales in scales_list:
        ...
        elif isinstance(prev_op, (nn.LayerNorm, MosesRMSNorm)) or "rmsnorm" in str(prev_op.__class__).lower():
