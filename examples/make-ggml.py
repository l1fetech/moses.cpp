#!/usr/bin/env python3
"""
This script converts Hugging Face Moses, StarCoder, Falcon, Baichuan, and GPT-NeoX models to GGUF and quantizes them.
...
- --model_type: (Required) The type of the model to be converted. Choose from moses, starcoder, falcon, baichuan, or gptneox.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', required=True, choices=['moses', 'starcoder', 'falcon', 'baichuan', 'gptneox'], help='Type of the model to be converted. Choose from moses, starcoder, falcon, baichuan, or gptneox.')
