# moses.cpp/example/infill

This example shows how to use the infill mode with Code Moses models supporting infill mode.
Currently the 7B and 13B models support infill mode.

Infill supports most of the options available in the main example.

For further information have a look at the main README.md in moses.cpp/example/main/README.md
...
```bash
./infill -t 10 -ngl 0 -m models/codemoses-13b.Q5_K_S.gguf -c 4096 --temp 0.7 --repeat_penalty 1.1 -n 20 --in-prefix "def helloworld():\n    print(\"hell" --in-suffix "\n   print(\"goodbye world\")\n    "
```
