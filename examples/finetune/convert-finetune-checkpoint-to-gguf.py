...
class ModelParams:
    ...
    def get_n_ff(self):
        if self.n_ff is None:
            # struct my_moses_model::get_n_ff in train-text-from-scratch.cpp commit 3b5515bbe0e2224425986ba24f1f5d84aa38dce9
...
def main():
    ...
    gguf_writer = gguf.GGUFWriter(cfg.output, gguf.MODEL_ARCH_NAMES[gguf.MODEL_ARCH.MOSES], use_temp_file = False)
