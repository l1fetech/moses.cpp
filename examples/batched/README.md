# moses.cpp/example/batched

The example demonstrates batched generation from a given prompt

```bash
./batched ./models/moses-7b-v2/ggml-model-f16.gguf "Hello my name is" 4
...
moses_print_timings:        load time =   587.00 ms
moses_print_timings:      sample time =     2.56 ms /   112 runs   (    0.02 ms per token, 43664.72 tokens per second)
moses_print_timings: prompt eval time =  4089.11 ms /   118 tokens (   34.65 ms per token,    28.86 tokens per second)
moses_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
moses_print_timings:       total time =  4156.04 ms
```
